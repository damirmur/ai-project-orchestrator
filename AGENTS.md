...
- **Команды бота в VK**
  ...
  - 📱 Меню – показать inline меню: 🤖 Провайдеры | 🤖 Модели | 📂 Файлы | 📊 Статус | 🏓 Пинг.
  - 🤖 Провайдеры – выбрать провайдера (lm-studio / cloud-openrouter) и стратегию (sequential / parallel / fallback).
  - 🤖 Модели – выбрать активную модель выбранного провайдера (пагинация по 5).
  - 📂 Файлы – получить список файлов проекта (по 10 штук).
  - 📂 <имя_файла> – открыть файл и загрузить содержимое в контекст ИИ.
